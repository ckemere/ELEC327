...
def add_arrows_to_svg(svg_file: str, violations: List[Tuple[float, float, int, int, str]], output_svg_file: str) -> str:
    ...
    Args:
        ...
        violations (List[Tuple]): List of (x, y, id, description) tuples
...
def create_html_report(svg_content: str, violations: List[Tuple[float, float, int, int, str]], output_html_file: str):
    ...
    <head>
        ...
        <script>
            ...
            function unhighlightArrow(arrowId) {{
    ...
    for (_, _, id, sub_id, description) in violations:
        ...
        html_content += f"""
                <tr id="row-{id}-{sub_id}" onmouseover="highlightArrow('arrow-{id}-{sub_id}')" onmouseout="unhighlightArrow('arrow-{id}-{sub_id}')">
                    <td>{row_label}</td>
                    <td>{description}</td>
                </tr>
        """
